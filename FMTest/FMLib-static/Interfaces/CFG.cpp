...
//*///------------------------------------------------------------------------------------------
//*///------------------------------------------------------------------------------------------
ValStoreLineT<std::string> CFG::ValSubTree(std::string name_)
{
	return  thatData.ValSubTree(name_);
}
//*///------------------------------------------------------------------------------------------
//*///------------------------------------------------------------------------------------------
...
//*///------------------------------------------------------------------------------------------
//*///------------------------------------------------------------------------------------------
void CFG::SetVal(string node_name_, ValStoreLineT<string> data_)
{
...
//*///------------------------------------------------------------------------------------------
//*///------------------------------------------------------------------------------------------
void CFG::SetValFromFile(string path_, string filename_)
{
...
{
	/*To Linux type*/
	path_ = STR::ReplaceInStrAll(path_, "\\", "/");
	/*Set data*/
...
//*///------------------------------------------------------------------------------------------
//*///------------------------------------------------------------------------------------------
pair<string, string> CFG::CutPathFromName(string str_)
{
	pair<string, string> result;
	/*To Linux format*/
	str_ = STR::ReplaceInStrAll(str_, "\\", "/");

	/*find place to split path and filename*/
	size_t fd = str_.find_last_of("/");
	result.first = str_.substr(0, fd);
	result.second = str_.substr(fd + 1, string::npos);
	return result;
}
//*///------------------------------------------------------------------------------------------
//*///------------------------------------------------------------------------------------------
