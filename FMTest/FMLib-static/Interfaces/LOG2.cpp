...
std::shared_ptr<boost::asio::io_service::work> LOG2::thatWork;
std::shared_ptr<boost::asio::io_service> LOG2::thatIo;
std::shared_ptr<std::thread> LOG2::thatThread;
ValStoreLineT<string> LOG2::thatData;
map<string, vector<boost::function<string()>>> LOG2::thatFuncs;

void LOG2::Init(vector<string> filenames_, std::shared_ptr<boost::asio::io_service> io_)
{
	SetConfig();
